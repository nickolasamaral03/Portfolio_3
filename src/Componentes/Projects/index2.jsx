...
const Projects2 = () => {
    return(
        ...
        <div>
            <div className='lg:flex lg:mx-10 m-auto justify-center dark:text-white sm:grid sm:ml-7'>
            ...
            <div className='lg:flex lg:mx-10 m-auto justify-center dark:text-white sm:grid sm:ml-7 my-16'>
