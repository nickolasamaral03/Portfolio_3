...
const Home = () => {
    ...
    <div className=' lg:mt-14 lg:ml-24 sm:grid-cols-1 sm:w-100 sm:mt-14'>
        <div className='grid'>
            ...
            <h1 className='lg:text-3xl dark:text-zinc-100 font-extrabold italic my-4 animate-pulse sm:text-2xl sm:ml-10'>Desenvolvedor Front-End</h1>
            <div className='flex'>
            <img src={Foto} alt="Minha Foto" className='lg:h-36 lg:w-36 ml-10 mt-5 rounded-full border-gray-600 border-2 sm:h-32 sm:w-32'/>
            <div className='flex mt-16 pl-7 border-b-2 border-gray-500 pb-4 h-12 ml-3'>
            ...
            <div className='lg:flex sm:grid'>
                ...
                <div className='lg:ml-36 lg:-mt-20 border-solid border-gray-200 dark:border-gray-500 border-2 p-5 bg-gray-200 dark:bg-gray-950 rounded-lg drop-shadow-md sm:m-auto sm:m-14 sm:mt-10 '>
                    <h4>
